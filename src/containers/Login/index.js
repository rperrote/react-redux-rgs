...
import '../../assets/img/wjGebMQB.jpeg';
...
class Login extends Component {
  render() {
    ...
    return (
      <div className={"login-box"} style={{margin: '11% auto'}}>
        <div className="login-logo">
          <img src="../../assets/img/wjGebMQB.jpeg" style={{width: '37%'}} />
        </div>
        <div className="login-box-body">
          <form styleName={"form"} onSubmit={handleSubmit(data => login(data))}>
            ...
            {username.touched &&
              username.error && (
                <InlineMessage type={"error"} message={username.error} />
              )}
            <PrimaryTextInput
              type={"text"}
            ...
            {password.touched &&
              password.error && (
                <InlineMessage type={"error"} message={password.error} />
              )}
            <PrimaryTextInput
              type={"password"}
            ...
            <div className={"clear-fix"} styleName={"actions"}>
              <InlineLink
                onClick={() => {
                  dispatch(routeActions.push("/forgot"));
                }}
              >
                Forgot Password?
              </InlineLink>
